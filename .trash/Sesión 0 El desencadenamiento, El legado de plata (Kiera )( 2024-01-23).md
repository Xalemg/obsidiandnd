...
banner_y: 0
---
# [[Personajes de El desencadenamiento, El desencadenamiento, El legado de plata (Kiera )]]
>[!cards| dataview 7]
>```dataview
...
>"**Max HP: "+hp+"**"
>FROM #personaje
>WHERE contains(En_curso, "si") AND contains(Campaña, El desencadenamiento, El desencadenamiento, El legado de plata (Kiera ))
>```
